-- Restore robust logic from 20260303230000 but fix the DATE vs TEXT type mismatch
-- This fixes the issue where paid events appear as pending in the dashboard
