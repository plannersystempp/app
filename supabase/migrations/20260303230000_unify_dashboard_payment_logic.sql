-- Migration: Unify Dashboard Payment Logic
-- 1. Correct UUID comparison for related_events
-- 2. Implement 12h divisor for implicit overtime rate
-- 3. Correct function-based cache priority
-- 4. 10 cent tolerance for rounding
