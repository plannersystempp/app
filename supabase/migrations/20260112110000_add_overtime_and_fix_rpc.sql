-- Add custom_overtime column to personnel_functions table
ALTER TABLE personnel_functions ADD COLUMN IF NOT EXISTS custom_overtime NUMERIC;

-- Update the RPC function to include custom_cache and custom_overtime
