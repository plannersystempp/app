-- Update RPC function to include custom_cache in the returned functions JSON
-- This ensures that the frontend receives the custom cache values when fetching personnel
